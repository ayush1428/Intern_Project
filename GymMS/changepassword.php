			...
			<div class="row">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="pricing-item entermediate">
						...
						<?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?>
						</div><?php } ?>
						...
						<form class="singup-form contact-form" method="post" onSubmit="return valid();">
							...
							<input type="submit" onclick="clicked()" id="submit" name="submit" value="Submit" class="site-btn sb-gradient">
